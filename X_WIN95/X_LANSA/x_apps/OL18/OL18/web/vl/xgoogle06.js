LANSA.addComponent({id:"XGOOGLE06",nm:"xGoogleBasicChart",ot:"ww",tp:"Widget",pt:"ap",de:"Basic Google Pie or Bar Chart",tl:14000101,cl:15000300},function(l,oI,u){var fF=function(wP){wP.fireItemGotSelection=function(pIndex,pCaption,pValue){var eP=l.ePs();eP.aI("INDEX",pIndex);eP.aS("CAPTION",pCaption);eP.aD("VALUE",pValue);l.fE(this,"ITEMGOTSELECTION",eP);};};var fW=
