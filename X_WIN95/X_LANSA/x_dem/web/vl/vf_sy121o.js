...
PROTOTYPE.Load = function( strFromURL, strRAMPScriptFile, strTheme, strBackgroundColor, strSessionGUID )
{
var pThis      = this;
...
};cO.mthUNLOAD=function(){this.invoke("unLoad");};cO.mthLOAD=function(P0,P1,P2,P3,P4){this.invoke("Load",[l.tS(P0),l.tS(P1),l.tS(P2),l.tS(P3),l.tS(P4)]);};cO.mthCLOSESESSION=function(){this.invoke("CloseSession");};},{rp:["PRIM_WDGT.Control"]});