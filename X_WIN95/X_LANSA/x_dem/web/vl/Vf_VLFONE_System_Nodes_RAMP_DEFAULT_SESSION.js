...
var vSD_FCC7629CBE8A419C84B44B7E51362F16 = {
 ...
 case "PRO_KEY":
 {
 SETVALUE("COMMAND","lansa run df_ramp dfrprom partition(" + objFramework.Partition + ")");
 SENDKEY(KeyEnter);
 ...
 case "ORD_KEY":
 {
 SETVALUE("COMMAND","lansa run df_ramp dfrordm partition(" + objFramework.Partition + ")");
 SENDKEY(KeyEnter);
 ...
 case "CUS_KEY":
 {
 SETVALUE("COMMAND","lansa run df_ramp dfrcusm partition(" + objFramework.Partition + ")");
 SENDKEY(KeyEnter);
...
var vSD_8958FB625D5945189548166542A127D4 = { // Do not change or delete this line
 vHandle_NAVIGATETO: function(sToForm, oPreviousForm)
 {
 var bReturn = true;
 HIDE_CURRENT_FORM();
...
var vSD_B467418407814CC1BC4147B3F9AA767C = {
 ...
 "Attention","PA1"),
 vFKSEQ : "0102030405060708091011121314151617181920212223242526272829303132333435363738",
 vFKERTS : "10001000000000000000000000000000000000",
...
function EXEC_026()
{
objNodeGroup.uRampStamp="20191018-004007";
